...
import '../../../../public/css/social_media.css'
...
const AboutTab = () => {
                        ...
                        showUserData ?
                            <div className='bg-gray-200 h-80 flex flex-col p-5 mt-14'>
                                ...
                                <div className={'flex items-center'}>
                                    <span><Image src={Work} alt={"Work Place"} height={5} width={17}></Image></span>
                                    <span className={'ml-2'}>Work at {viewerUser.userBio.companyName}</span>
                                </div>

                                <div className={'flex items-center mt-3'}>
                                    <span><Image src={Programming} alt={"Language"} height={5}
                                                 width={20}></Image></span>
                                    <span className={'ml-2'}>Expertise in {viewerUser.userBio.mainLanguage}</span>
                                </div>

                                <div className={'flex items-center mt-3'}>
                                    <span><Image src={Experience} alt={"Language"} height={5}
                                                 width={20}></Image></span>
                                    <span
                                        className={'ml-2'}>{viewerUser.userBio.experience} year{viewerUser.userBio.experience > 1 ? "s" : ""} Experience in Programming</span>
                                </div>

                                <div className={'flex items-center mt-5'}>
                                    <span className={'ml-2 font-medium text-lg'}>Social Media</span>
                                    <span>
                                        <div className="card">
  ...
  <a className="social-link5">
    <svg viewBox="0 0 16 16" className="bi bi-stack-overflow" fill="currentColor" height="16" width="16"
         xmlns="http://www.w3.org/2000/svg">
      <path d="M12.412 14.572V10.29h1.428V16H1v-5.71h1.428v4.282h9.984z"></path>
      <path
          d="M3.857 13.145h7.137v-1.428H3.857v1.428zM10.254 0 9.108.852l4.26 5.727 1.146-.852L10.254 0zm-3.54 3.377 5.484 4.567.913-1.097L7.627 2.28l-.914 1.097zM4.922 6.55l6.47 3.013.603-1.294-6.47-3.013-.603 1.294zm-.925 3.344 6.985 1.469.294-1.398-6.985-1.468-.294 1.397z"></path>
    </svg>
  </a>
</div>
                            ...
                            <div className='bg-gray-200 h-80 flex flex-col justify-center items-center px-20 mt-14'>
                                ...
                                <span className='font-bold text-xl'>User doesn't update Bio yet</span>
                            </div>
                        :
                        <div className='bg-gray-200 h-80 flex flex-col justify-center items-center px-20 mt-14'>
                            ...
                            <button
                                className='border border-black px-4 py-1 rounded-full hover:bg-black hover:text-white'>Get
                                Started
                            </button>
                        </div>
                }
