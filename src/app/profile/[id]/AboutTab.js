            ...
            <div className="bg-gray-200 h-80 flex flex-col p-5 mt-14">
              ...
              <div className={"flex flex-col mt-5"}>
                ...
                <div className={'flex mt-2'}>
                    <span className={'mr-3 cursor-pointer'}><Image src={Facebook} alt={"facebook"} height={20} width={25}></Image></span>
                    <span className={'mr-3 cursor-pointer'}><Image src={Linkedin} alt={"linkin"} height={20} width={25}></Image></span>
                    <span className={'mr-3 cursor-pointer'}><Image src={Github} alt={"github"} height={20} width={25}></Image></span>
                </div>
              </div>
            </div>
          ) : (
