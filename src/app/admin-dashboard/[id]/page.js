            ...
            <div className="flex flex-col w-full h-screen items-center mt-10">
                    <div className="w-full flex flex-col max-w-7xl justify-center items-center">
                        <div className="w-full flex justify-between">
                            ...
                            <div>
                                <button className="bg-green-600 text-white rounded-full px-3 py-1 mr-3">Publish</button>
                        ...
                        <div className="max-w-4xl w-full mt-16 flex flex-col font-serif">
                            <div>
                                {hideBtn && (
                                    <button className="rounded-full px-2 text-2xl border border-black">+</button>
                                )}
                                <input
                                    className="hover:border-transparent focus:border-transparent outline-none px-4 text-5xl"
                                    placeholder="Title"
                                    onClick={handleContainerMouseEnter}
                                    onMouseLeave={handleContainerMouseLeave}
                                />
                            </div>

                            <textarea cols="10" rows="50" className="hover:border-transparent focus:border-transparent outline-none px-4 text-2xl mt-5 block" placeholder="Tell Your Story"></textarea>
                        </div>
                    </div>
            </div>
        </>
